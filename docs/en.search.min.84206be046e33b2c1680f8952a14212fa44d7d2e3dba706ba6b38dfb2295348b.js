...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/en.search-data.min.f9623fd8ccbd7286230367a6ecb07b7476ae8d9f592a8088aabfb34dcda0a4ff.js',function(){input.required=false;search();});}
