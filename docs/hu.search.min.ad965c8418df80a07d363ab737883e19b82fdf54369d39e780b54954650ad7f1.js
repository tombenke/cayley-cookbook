...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/hu.search-data.min.36104ffbbcc981d5ef359b4e76bfdfbac07f86292315cbb727a123766e64ff3a.js',function(){input.required=false;search();});}
