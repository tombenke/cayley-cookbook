...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/hu.search-data.min.be97fd87a9383935f2e47df18cb84aaf69c173709fb68f6582836fcaba43c669.js',function(){input.required=false;search();});}
