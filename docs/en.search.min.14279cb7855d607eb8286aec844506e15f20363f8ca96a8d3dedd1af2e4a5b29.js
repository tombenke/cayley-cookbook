...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/en.search-data.min.1c4e46fd51c122119136d632c6a06ba585ee97c2f6eccaf51abd0fbf90bd6ce2.js',function(){input.required=false;search();});}
