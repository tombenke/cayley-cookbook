...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/hu.search-data.min.90eeef8c670ca3e3d1a79657ab3fe84bc4052ace6ed096f783c832daf964d1f1.js',function(){input.required=false;search();});}
