...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/en.search-data.min.f87bd735d7d3eea1cbefab6a23f14cab2c5595cab2137f6efc9a3a9d53792f1d.js',function(){input.required=false;search();});}
