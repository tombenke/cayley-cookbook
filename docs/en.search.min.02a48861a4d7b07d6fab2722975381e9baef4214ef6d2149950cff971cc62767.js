...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/en.search-data.min.8bbaebfcb70817fc3d07edb1f2cc820a66461231c5fcf14cd26c5702a33a608c.js',function(){input.required=false;search();});}
