...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/en.search-data.min.04050513c9ab670fe94399145832aecabf7cb22cb8188eeef1183635a660c0a2.js',function(){input.required=false;search();});}
