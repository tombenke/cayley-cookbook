...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/en.search-data.min.35c8650b4f32f5489252dabb961a3664cd19dcafec118b99ecd329842649c188.js',function(){input.required=false;search();});}
