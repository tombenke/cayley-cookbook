...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/hu.search-data.min.16d5def7566311211ff1732d251d38550f3c68d9dccec57d3ad452d3b17ba1d8.js',function(){input.required=false;search();});}
