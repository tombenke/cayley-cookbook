...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/en.search-data.min.1f3453a032e4e34bdf8214bd17384495253bdef8715a3baf74fd93e0eb5cf375.js',function(){input.required=false;search();});}
