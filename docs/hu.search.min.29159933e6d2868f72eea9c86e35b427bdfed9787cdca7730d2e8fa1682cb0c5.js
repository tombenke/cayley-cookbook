...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cayley-cookbook/flexsearch.min.js');loadScript('/cayley-cookbook/hu.search-data.min.24a6b746049325a178860165f14a09ba3fad42ba965d49911e058c99b3c51466.js',function(){input.required=false;search();});}
